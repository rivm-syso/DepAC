...
contains
    ...
    subroutine test_gsoil_default(error)
        ...
        ! This is a placeholder test for gsoil parameterisation. The actual tests are in the
    ...
    subroutine test_rsoil_rinc_no_path(error)
        ...
        rinc = rinc_no_path(rc_rinc, meteo, dp_conf)
    ...
    subroutine test_rsoil_rinc_no_resistance(error)
        ...
        rinc = rinc_no_resistance(rc_rinc, meteo, dp_conf)
